...
| Lua/source reference | Android implementation |
| --- | --- |
...
| Compact Windows-installer logo | assets/stemwerk_installer.svg, shown in a contained 96dp header |
...
The compact header deliberately uses the static installer artwork. The animated REAPER artwork remains a reference asset, but is not used as a full-bleed Android header.
